...
export default function HeroSection() {
  return (
    <section className="overflow-hidden bg-primary text-white pt-16 sm:pt-0">
      <div className="border-b border-white/20 bg-primary/90 px-4 py-2 text-center text-[11px] font-medium tracking-wide sm:text-xs">
      ...
      <div className="container mx-auto px-4 py-10 sm:py-12 md:py-20">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mt-4 text-sm text-white/80 md:text-base px-2 sm:px-0">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:justify-center">
            <Link
              ...
              className="rounded-md bg-white px-6 py-2.5 text-center font-semibold text-primary transition hover:bg-white/90"
            >
              Start Shopping
            </Link>
            <Link
              href={ROUTES.LOGIN}
              className="rounded-md border border-white px-6 py-2.5 text-center font-semibold transition hover:bg-white/10"
            >
              Sign In
            </Link>
          </div>
