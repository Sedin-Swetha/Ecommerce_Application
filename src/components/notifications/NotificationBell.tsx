...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 top-full z-50 mt-2 w-80 overflow-hidden rounded-xl border border-gray-100 bg-white shadow-lg">
          ...
          {notifications.length > 0 && (
            <button
              onClick={clearAll}
              className="w-full border-t border-gray-100 py-2.5 text-xs font-semibold text-gray-400 hover:bg-gray-50 hover:text-gray-600 transition"
            >
              Clear all
            </button>
          )}
