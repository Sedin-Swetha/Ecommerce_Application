    ...
    const field = (label: string, key: keyof AdminProductForm, type = "text", placeholder = "") => (
        <div className="flex flex-col gap-1">
            ...
            <input
                ...
                className={`rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 ${errors[key] ? "border-red-400 bg-red-50" : "border-gray-200"
                    }`}
            />
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <textarea
                        ...
                        className={`rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 resize-none ${errors.description ? "border-red-400 bg-red-50" : "border-gray-200"
                            }`}
                    />
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        ...
                        className={`rounded-lg border px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 ${errors.images ? "border-red-400 bg-red-50" : "border-gray-200"
                            }`}
                    />
                ...
                <label className="flex cursor-pointer items-center justify-between rounded-xl border border-gray-200 bg-gray-50 px-4 py-3">
                    ...
                    <div
                        ...
                        className={`relative h-6 w-11 rounded-full transition-colors duration-200 ${form.isFeatured ? "bg-primary" : "bg-gray-300"
                            }`}
                    >
