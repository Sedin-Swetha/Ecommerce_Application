...
export default function ProductCard({
    ...
    return (
        <div className="flex flex-col overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-0.5 h-full">
            <div
                className="relative w-full overflow-hidden bg-gray-50 dark:bg-gray-800/50"
            ...
            >
                ...
                {product.stock === 0 && (
                    <div className="absolute inset-0 flex items-center justify-center bg-black/40">
                        <span className="rounded-full bg-white/90 dark:bg-gray-900/90 px-3 py-1 text-xs font-semibold text-gray-700 dark:text-gray-300">
                            Out of Stock
                        </span>
                    </div>
                )}
            ...
            <div className="flex flex-1 flex-col p-3 gap-1">
                ...
                <h3
                    className="line-clamp-2 text-sm font-semibold leading-tight text-gray-900 dark:text-white"
                ...
                <div className="mt-auto pt-2">
                    {isAdmin ? (
                        ...
                        <div className="flex items-center justify-between rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 p-0.5">
                            <button
                                onClick={(e) => { e.preventDefault(); decreaseQuantity(product.id); }}
                                className="flex h-8 w-8 items-center justify-center rounded-md bg-white dark:bg-gray-700 text-base font-bold text-gray-700 dark:text-gray-200 shadow-sm hover:bg-gray-100 dark:hover:bg-gray-600"
                            >
                                −
                            </button>
            ...
            {isAdmin && (
                <div className="flex gap-2 border-t border-gray-100 dark:border-gray-800 px-3 py-2">
                    <button
