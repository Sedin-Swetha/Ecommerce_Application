    ...
    <div className="mx-auto max-w-5xl px-4 py-10">
      ...
      <div className="grid grid-cols-1 gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-baseline gap-3">
            ...
            {product.discount > 0 && (
              <>
                ...
                <span className="rounded-md bg-red-50 px-2 py-0.5 text-sm font-bold text-red-500">
          ...
          <div className="mt-2">
            {product.stock === 0 ? (
              <button disabled className="w-full cursor-not-allowed rounded-xl bg-gray-200 py-3 text-sm font-medium text-gray-500">
                Out of Stock
              </button>
            ) : quantity === 0 ? (
              <button
                onClick={() => addItem(product.id)}
                className="w-full rounded-xl bg-primary py-3 text-sm font-bold text-white hover:bg-primary-dark transition"
              >
                Add to Cart
              </button>
            ) : (
              <div className="flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 p-1">
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-xl font-bold text-gray-700 shadow-sm hover:bg-gray-100"
                >
                  −
                </button>
                ...
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-lg bg-primary text-xl font-bold text-white hover:bg-primary-dark"
                >
                  +
                </button>
              </div>
      ...
      <ConfirmDialog
        ...
        message={`"${product.name}" will be permanently deleted and you'll be redirected to the products page.`}
