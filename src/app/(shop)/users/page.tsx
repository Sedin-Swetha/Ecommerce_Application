...
export default function UsersPage() {
  ...
  const stats = [
    { label: "Total Users",    value: totalUsers,   bg: "bg-blue-50",    text: "text-blue-700",   border: "border-blue-200"   },
    { label: "Active Users",   value: activeUsers,  bg: "bg-emerald-50", text: "text-emerald-700",border: "border-emerald-200" },
    { label: "Blocked Users",  value: blockedUsers, bg: "bg-red-50",     text: "text-red-700",    border: "border-red-200"    },
    { label: "Admins",         value: adminUsers,   bg: "bg-violet-50",  text: "text-violet-700", border: "border-violet-200" },
  ];
  return (
